...
function array_tests() {
    return [
        new TestCase("array_concat_ext should combine two arrays into the original array without issue", function() {
            var a = [1, 2, 3];
            var b = [4, 5, 6];
        ...
        new TestCase("array_concat_ext should combine two arrays into the second array without issue", function() {
            var a = [1, 2, 3];
            var b = [4, 5, 6];
            var _expect = [1, 2, 3, 4, 5, 6];
        ...
        new TestCase("array_concat_ext should combine two arrays into a new array", function() {
            var a = [1, 2, 3];
            var b = [4, 5, 6];
            var _expect = [1, 2, 3, 4, 5, 6];
        ...
        new TestCase("array_shift should default remove first element in array", function() {
            var a = [1, 2, 3];
            var _expectA = [2, 3];
            var _expectResult = [1];
        ...
        new TestCase("array_shift should remove be able to remove multiple elements in array", function() {
            var a = [1, 2, 3, 4, 5];
            
            matcher_arrays_equal(array_shift(a, 5), [1, 2, 3, 4, 5]);
            matcher_arrays_equal(a, []);
        }),
        new TestCase("array_shift should throw if you try and shift more than the array size", function() {
            matcher_should_throw(function() {
                var a = [1, 2, 3, 4, 5];
                array_shift(a, 6);
            });
        }),
        new TestCase("array_join should return the stringified values seperated by default nothing", function() {
            var a = [1, 2, 3, 4, 5];
            var _expect = "12345";
        ...
        new TestCase("array_join should return the stringified values seperated by 1 character _seperator", function() {
            var a = [1, 2, 3, 4, 5];
        ...
        new TestCase("array_join should return the stringified values seperated by multi character _seperator", function() {
            var a = [1, 2, 3, 4, 5];
            var _expect = "1, 2, 3, 4, 5";
            var _seperator = ", ";
